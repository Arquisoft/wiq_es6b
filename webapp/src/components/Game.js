...
const Game = ({username}) => {
  ...
  const questionTypes = useMemo(() => ({
    ...
    "actor": {
      query: `
        SELECT ?actor ?actorLabel ?birthPlace ?birthPlaceLabel
        WHERE {
          ?actor wdt:P31 wd:Q5.
        ...
        LIMIT 150
      `,
      questionLabel: 'actorLabel',
      answerLabel: 'birthPlaceLabel'
    },
    "pelicula": {
      query: `
        ...
        LIMIT 150
      `,
      questionLabel: 'filmLabel',
      answerLabel: 'directorLabel'
    },
    "compositor": {
      query: `
        SELECT ?composer ?composerLabel ?birthPlace ?birthPlaceLabel
        WHERE {
